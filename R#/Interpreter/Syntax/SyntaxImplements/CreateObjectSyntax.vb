#Region "Microsoft.VisualBasic::429992da0c4d5a06e1bc75ee84863b8f, R#\Interpreter\Syntax\SyntaxImplements\CreateObjectSyntax.vb"
...
Namespace Interpreter.SyntaxParser.SyntaxImplements
    ...
    Module CreateObjectSyntax
        ...
        Public Function CreateNewObject(keyword As Token, tokens As Token(), opts As SyntaxBuilderOptions) As SyntaxResult
            ...
            Dim blocks = tokens.Skip(1).SplitByTopLevelDelimiter(Language.TokenType.close, True, ")")
