#Region "Microsoft.VisualBasic::cd561d606ef7e3e4a2c6d14ff74b572d, R#\Interpreter\Debugger\ConsoleDebuggerFrontend.vb"
    ...
    '   Total Lines: 370
    '    Code Lines: 248 (67.03%)
    ' Comment Lines: 64 (17.30%)
    '    - Xml Docs: 84.38%
    ' 
    '   Blank Lines: 58 (15.68%)
    '     File Size: 15.93 KB
    ...
    ' 
    '         Function: parseLocation, processCommand
    ' 
    '         Sub: Attach, Detach, OnPause, printBreakpoints, printCallStack
    '              printHeader, printHelp, printSource, printVariables, processBreakCommand
    '              processDeleteCommand, processEvaluate
    ' 
    ' 
    ' /********************************************************************************/
