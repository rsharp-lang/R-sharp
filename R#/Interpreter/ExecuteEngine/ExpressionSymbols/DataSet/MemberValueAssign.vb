#Region "Microsoft.VisualBasic::0dd34495dcf39ada40215dd63eac4fd0, R#\Interpreter\ExecuteEngine\ExpressionSymbols\DataSet\MemberValueAssign.vb"
...
Namespace Interpreter.ExecuteEngine.ExpressionSymbols.DataSets
    ...
    Public Class MemberValueAssign : Inherits Expression
        ...
        Public Overrides Function Evaluate(envir As Environment) As Object
            ...
            Else
                Return list.setByName(names, Runtime.asVector(Of Object)(result), envir)
            End If
        End Function
