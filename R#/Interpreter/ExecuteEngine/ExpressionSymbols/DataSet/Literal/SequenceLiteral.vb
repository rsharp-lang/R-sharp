#Region "Microsoft.VisualBasic::bc372790cb6243deeb3219111481f962, R#\Interpreter\ExecuteEngine\ExpressionSymbols\DataSet\Literal\SequenceLiteral.vb"
        ...
        Private Shared Function measureSequence(init As Object, stops As Object, offset As Object) As String
            Dim test = New Object() {init, stops, offset} _
                .Select(Function(num)
                            ...
                            If ntype Like RType.integers Then
                                Return "int"
                            ElseIf ntype Like RType.floats Then
                                ' 20260213 fix for test integer value
                                Dim dbl As Double = CLRVector.asNumeric(num)(0)

                                If dbl = System.Math.Truncate(dbl) Then
                                    Return "int"
                                Else
                                    Return "num"
                                End If
