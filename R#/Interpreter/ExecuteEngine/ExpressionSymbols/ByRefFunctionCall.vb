#Region "Microsoft.VisualBasic::683b99b6ae1b37cfe85f2e0f8547f8f0, R#\Interpreter\ExecuteEngine\ExpressionSymbols\ByRefFunctionCall.vb"
...
Namespace Interpreter.ExecuteEngine
    ...
    Public Class ByRefFunctionCall : Inherits Expression
        ...
        Public Overrides Function Evaluate(envir As Environment) As Object
            Dim names As Array = value.Evaluate(envir)
            Dim target = Me.target.Evaluate(envir)

            Select Case funcName
                Case "names"
                    Return base.names(target, names, envir)
                Case "colnames"
                    Return base.colnames(target, names, envir)
                Case Else
