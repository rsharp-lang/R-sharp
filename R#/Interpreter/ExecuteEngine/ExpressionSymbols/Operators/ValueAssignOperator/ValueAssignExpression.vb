#Region "Microsoft.VisualBasic::c769f4b2dbc8c0de10faf3e29933f9e7, R#\Interpreter\ExecuteEngine\ExpressionSymbols\Operators\ValueAssignOperator\ValueAssignExpression.vb"
    ...
    '   Total Lines: 426
    '    Code Lines: 302 (70.89%)
    ' Comment Lines: 63 (14.79%)
    '    - Xml Docs: 68.25%
    ' 
    '   Blank Lines: 61 (14.32%)
    '     File Size: 18.29 KB
                ...
                Case GetType(VectorLoop)
                    ...
                    ElseIf obj.GetType.IsInheritsFrom(GetType(s4Reflector)) Then
                        ...
                        ElseIf slotName.Length = 1 Then
                            Dim err = DirectCast(obj, s4Reflector).setByName(slotName(0), value, envir)

                            If TypeOf err Is Message Then
                                Return err
                            Else
                                Return Nothing
                            End If
                        Else
                            Dim err = DirectCast(obj, s4Reflector).setByName(slotName, value, envir)
