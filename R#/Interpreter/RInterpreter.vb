...
Namespace Interpreter
    ...
    Public Class RInterpreter : Implements IDisposable
        ...
        Private Sub _construct(env As GlobalEnvironment)
            ...
            _globalEnvir.Push("NA_integer_", Double.NaN, True, TypeCodes.double)
            _globalEnvir.Push("NA_real_", Double.NaN, True, TypeCodes.double)
            _globalEnvir.Push("NA_complex_", Double.NaN, True, TypeCodes.double)
            _globalEnvir.Push("NA_character_", Nothing, True, TypeCodes.string)
