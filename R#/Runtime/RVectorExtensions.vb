#Region "Microsoft.VisualBasic::d330edce4c2131a70a1c9895ca2c0e6a, R#\Runtime\RVectorExtensions.vb"
    ...
    '   Total Lines: 614
    '    Code Lines: 411 (66.94%)
    ' Comment Lines: 131 (21.34%)
    '    - Xml Docs: 84.73%
    ' 
    '   Blank Lines: 72 (11.73%)
    '     File Size: 23.89 KB
    ...
    '                   CTypeOfList, DirectCastGenericArray, fromArray, getFirst, getScalar
    '                   isScalarVector, isVector, MeltArray, TryCastGenericArray, (+2 Overloads) UnsafeTryCastGenericArray
    ' 
    ' 
    ' /********************************************************************************/
...
Namespace Runtime
    ...
    <HideModuleName> Public Module RVectorExtensions
        ...
        Public Function UnsafeTryCastGenericArray(vec As Array) As Array
            ...
            Return UnsafeTryCastGenericArray(vec, elementType)
        End Function
        ...
        ''' propably returns an array with all element value is nothing
        ''' </returns>
        Public Function UnsafeTryCastGenericArray(vec As Array, elementType As Type) As Array
