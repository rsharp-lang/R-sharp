#Region "Microsoft.VisualBasic::9bcd6f0ca6714e1b95435b77de15ae7a, R#\Runtime\Internal\debug.vb"
    ...
    Public NotInheritable Class debug
        ...
        Public Shared Function [stop](message As Object, envir As Environment,
            ...
            Else
                ...
                If debugMode Then
                    Throw err
                Else
                    Return Internal.debug.CreateMessageInternal(message, envir, level:=MSG_TYPES.ERR)
                End If
            End If
        End Function
        ...
        Public Shared Sub writeErrMessage(message As Message,
            ...
            If Not message.environmentStack.IsNullOrEmpty Then
                Call dev.WriteLine()
                Call dev.WriteLine(Internal.debug.PrintRStackTrace(message.environmentStack))
            End If
