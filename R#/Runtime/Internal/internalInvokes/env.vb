#Region "Microsoft.VisualBasic::6b352794e94d3a059a9e8b6e568939ae, R#\Runtime\Internal\internalInvokes\env.vb"
    ...
    '   Total Lines: 687
    '    Code Lines: 337 (49.05%)
    ' Comment Lines: 287 (41.78%)
    '    - Xml Docs: 87.46%
    ' 
    '   Blank Lines: 63 (9.17%)
    '     File Size: 31.36 KB
    ...
    '                   objects, objectSize, relative_work, rm, traceback
    '                   unlockBinding
    ' 
    ' 
    ' /********************************************************************************/
