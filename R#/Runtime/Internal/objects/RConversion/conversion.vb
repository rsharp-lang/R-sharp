#Region "Microsoft.VisualBasic::cff514effaecb0afbe8958da47bf2db6, R#\Runtime\Internal\objects\RConversion\conversion.vb"
    ...
    '   Total Lines: 1398
    '    Code Lines: 827 (59.16%)
    ' Comment Lines: 433 (30.97%)
    '    - Xml Docs: 78.06%
    ' 
    '   Blank Lines: 138 (9.87%)
    '     File Size: 63.16 KB
...
#Enable Warning
        ...
        Public Function asDataframe(<RRawVectorArgument> x As Object,
            ...
            Else
                ...
                If DirectCast(args, list).hasName("features") Then
                    If TypeOf x Is list Then
