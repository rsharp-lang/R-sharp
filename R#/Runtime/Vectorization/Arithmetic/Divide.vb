#Region "Microsoft.VisualBasic::44f3a69c379c478d3aa67c573b46b387, F:/GCModeller/src/R-sharp/R#//Runtime/Vectorization/Arithmetic/Divide.vb"
...
Namespace Runtime.Vectorization
    ...
    Public Class Divide
        ...
        Public Shared Function f64_op_divide_f64(x As Object, y As Object, env As Environment) As Object
            ...
            ElseIf vx.Mode = VectorTypes.Scalar Then
                ' scalar / vector
                Return SIMD.Divide.f64_scalar_op_divide_f64(CDbl(vx.single), vy.vector)
            ElseIf vy.Mode = VectorTypes.Scalar Then
                ' vector / scalar
                Return SIMD.Divide.f64_op_divide_f64_scalar(vx.vector, CDbl(vy.single))
            ...
            Else
                ' vector / vector
                Return SIMD.Divide.f64_op_divide_f64(vx.vector, vy.vector)
            End If
        End Function
    End Class
End Namespace
