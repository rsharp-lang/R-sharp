#Region "Microsoft.VisualBasic::bcaa27ace8f6df76b4ca2546daee7c58, E:/GCModeller/src/R-sharp/R#//Runtime/Vectorization/Arithmetic/Exponent.vb"
...
Namespace Runtime.Vectorization
    ...
    Public Class Exponent
        ...
        Public Shared Function f64_op_exponent_f64(x As Object, y As Object, env As Environment) As Object
            ...
            ElseIf vx.Mode = VectorTypes.Scalar Then
                ' scalar ^ vector
                Return SIMD.Exponent.f64_scalar_op_exponent_f64(CDbl(vx.single), vy.vector)
            ElseIf vy.Mode = VectorTypes.Scalar Then
                ' vector ^ scalar
                Return SIMD.Exponent.f64_op_exponent_f64_scalar(vx.vector, CDbl(vy.single))
            ...
            Else
                ' vector ^ vector
                Return SIMD.Exponent.f64_op_exponent_f64(vx.vector, vy.vector)
            End If
        End Function
    End Class
End Namespace
