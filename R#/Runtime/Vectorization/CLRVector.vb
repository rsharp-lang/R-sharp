#Region "Microsoft.VisualBasic::dd2c8f06433f1fe5ac7e27fa49f52b9a, R#\Runtime\Vectorization\CLRVector.vb"
    ...
    '   Total Lines: 701
    '    Code Lines: 543 (77.46%)
    ' Comment Lines: 86 (12.27%)
    '    - Xml Docs: 68.60%
    ' 
    '   Blank Lines: 72 (10.27%)
    '     File Size: 28.59 KB
    ...
    '                   asScalarLogical, asScalarNumber, castVector, fromObjectCollection, parseString
        ...
        Public Function asCharacter(x As Object) As String()
            ...
            If typeof_x.IsArray Then
                ...
                Else
                    typeof_x = x.GetType
                End If
            ElseIf x.GetType.ImplementInterface(Of ICollection) AndAlso DirectCast(x, ICollection).Count = 1 Then
                Return asCharacter(DirectCast(x, ICollection)(0))
            End If
