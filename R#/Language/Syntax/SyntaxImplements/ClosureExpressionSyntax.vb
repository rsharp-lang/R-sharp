#Region "Microsoft.VisualBasic::0bf444b88d2d752f2f02fb7dbeac426c, R#\Language\Syntax\SyntaxImplements\ClosureExpressionSyntax.vb"
        ...
        Public Function ClosureExpression(tokens As IEnumerable(Of Token), opts As SyntaxBuilderOptions) As SyntaxResult
            ...
            Else
                ...
                For Each member As Token() In lineBlocks
                    ...
                    Dim valExpr = opts.ParseExpression(value)
