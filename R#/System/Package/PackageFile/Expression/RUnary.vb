#Region "Microsoft.VisualBasic::d3a8c39c2a5090306a3295717e436071, F:/GCModeller/src/R-sharp/R#//System/Package/PackageFile/Expression/RUnary.vb"
            ...
            Using bin As New BinaryReader(buffer)
                ...
                Select Case raw.expression
                    ...
                    Case ExpressionTypes.UnaryNumeric
                        Dim op As String = Encoding.ASCII.GetString(StreamHelper.ReadZEROBlock(bin).ToArray)
