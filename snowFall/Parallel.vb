...
#Enable Warning
    ...
    Public Function parallel(task As Expression,
        ...
        Call println($"config for slave parallel: {slaveParallel}")
        Call println($"debug: {debug}")
        Call println($"debug flag for parallel engine: {debug OrElse Not slaveParallel}")
