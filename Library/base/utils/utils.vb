#Region "Microsoft.VisualBasic::9cda41504f320c7a545b638224bdcc49, Library\base\utils\utils.vb"
...
'   Total Lines: 855
'    Code Lines: 515 (60.23%)
' Comment Lines: 257 (30.06%)
'    - Xml Docs: 92.22%
' 
'   Blank Lines: 83 (9.71%)
'     File Size: 43.98 KB
...
Imports csvData = Microsoft.VisualBasic.Data.Framework.StorageProvider.DataFrameResolver
...
Imports CSVFrame = Microsoft.VisualBasic.Data.Framework.DataFrame
...
Public Module utils
    ...
    Private Function saveTextFile(env As Environment,
        ...
        If type Is GetType(Rdataframe) Then
            ...
            End If
        ElseIf type Is GetType(CSVFrame) Then
            Return DirectCast(x, CSVFrame).WriteCsv(file, blank:=meta_blank)
