#Region "Microsoft.VisualBasic::7b900b14d522079cd50530838def2144, Rscript\CLI\CLI.vb"
...
<CLI> Module CLI
    ...
    Public Function Check(args As CommandLine) As Integer
        ...
        Dim tmpCheck As String = App.GetAppSysTempFile("___check/", App.PID, "package_")
