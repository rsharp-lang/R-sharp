...
Public Module VectorMath
    ...
    Public Function BesselI(x As Vector, nu As Vector,
                            <Parameter("expon.scaled", "logical; if TRUE, the results are exponentially scaled in order to avoid overflow (I(nu)) or underflow (K(nu)), respectively.")> Optional ExponScaled As Boolean = False) As Vector
...
''' </summary>
''' <remarks></remarks>
<[Namespace]("Poisson", description:="Density, distribution function, quantile function and random generation for the Poisson distribution with parameter lambda.")>
