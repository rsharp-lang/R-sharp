...
Namespace Runtime.DeviceDriver
    ...
    Public MustInherit Class DriverBase(Of
             ...
             Handler,
             __TYPE_ID) : Inherits ShoalShell.Runtime.SCOM.RuntimeComponent
        ...
        Protected Shared Function GetMethods([module] As ShoalShell.SPM.Nodes.PartialModule) As __TYPEHwnd()
