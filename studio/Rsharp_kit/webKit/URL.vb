#Region "Microsoft.VisualBasic::1e5f702df59c769e7c5c9bab0fc3589d, D:/GCModeller/src/R-sharp/studio/Rsharp_kit/webKit//URL.vb"
...
Public Module URL
    ...
    Private Function runHttpRequest(url As String,
        ...
        Catch ex As Exception When TypeOf ex Is WebException
            ...
            Dim code_i32 As Long

            If code.StringEmpty Then
                code_i32 = 500
            Else
                code_i32 = Long.Parse(code)
            End If
