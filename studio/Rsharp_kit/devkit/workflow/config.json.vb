#Region "Microsoft.VisualBasic::94470f4b757342ca110bf3bc6c0930b9, E:/GCModeller/src/R-sharp/studio/Rsharp_kit/devkit//workflow/config.json.vb"
    ...
    Public Shared Function BuildTemplate(Rscript As ShellScript) As ConfigJSON
        ...
        For Each arg In Rscript.argumentList
            ...
            If defaultValue Is Nothing Then
                jsonVal = Nothing
            Else
                jsonVal = If(defaultValue.isLiteral, defaultValue.GetLiteralValue, Nothing)
            End If

            endPoint.add(tokens.Last, jsonVal)
        Next
