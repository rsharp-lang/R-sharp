#Region "Microsoft.VisualBasic::1287c5cf5325af51440860584ecfd551, studio\Rsharp_kit\devkit\devkit.vb"
...
Module devkit
    ...
    Public Function inspect(script As String, Optional env As Environment = Nothing) As Object
        ...
        If globalEnv.polyglot.CanHandle(script) Then
            ...
            End If
        Else
            Return RInternal.debug.stop({$"unsupported script file type(*.{script.ExtensionSuffix})!"}, globalEnv)
        End If
    End Function
End Module
